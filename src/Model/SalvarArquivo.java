...
public class SalvarArquivo {
	...
	/*
	 * // Método para escrever os dados no arquivo public void EscreverArq() throws
	 * IOException {
	 * 
	 * PrintWriter arq = null; navios1 = BatalhaNaval.getNavios1(); navios2 =
	 * BatalhaNaval.getNavios2(); tiros1 = BatalhaNaval.getTiros1(); tiros2 =
	 * BatalhaNaval.getTiros2(); qtd_tiros1 = BatalhaNaval.getQtd_tiros1();
	 * qtd_tiros2 = BatalhaNaval.getQtd_tiros2();
	 * 
	 * 
	 * arq = new PrintWriter(new FileWriter("dados_partida.txt"));
	 * 
	 * arq.write("Jogador 1\n"); if (navios1 != null) { for (int i =0; i<5;i++) {
	 * arq.write(navios1[i]); arq.write("\n"); } } arq.write("\n"); if (qtd_tiros1
	 * != 0) { for (int i =0; i<qtd_tiros1;i++) { if (tiros1[i] != null) {
	 * arq.write(tiros1[i]); arq.write("\n"); } } arq.write("\n"); }
	 * arq.write("Jogador 2\n"); if (navios2 != null) { for (int i =0; i<5;i++) {
	 * arq.write(navios2[i]); arq.write("\n"); } } arq.write("\n"); if (qtd_tiros2
	 * != 0) { for (int i =0; i<qtd_tiros2;i++) { if (tiros2[i]!=null) {
	 * arq.write(tiros2[i]); arq.write("\n"); } } }
	 * 
	 * arq.close(); }
	 */
